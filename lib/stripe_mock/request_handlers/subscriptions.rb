module StripeMock
  module RequestHandlers
    module Subscriptions
      ...
      # 1) is in trial
      # 2) is free
      # 3) has billing or collection_method set to send invoice
