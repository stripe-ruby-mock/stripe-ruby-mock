# stripe-ruby-mock [![Build Status](https://travis-ci.org/GeorgeErickson/stripe-ruby-mock.png?branch=master)](https://travis-ci.org/GeorgeErickson/stripe-ruby-mock)
